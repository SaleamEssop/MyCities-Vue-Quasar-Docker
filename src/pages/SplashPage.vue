  ...
  <q-page class="splash-page">
    ...
    <div class="app-header">
      <div class="header-content">
        ...
        <!-- Login/Logout Link -->
        <a v-if="isLoggedIn" href="#" class="login-link logout-link" @click.prevent="handleLogout">
          Logout
        </a>
    ...
    >
      ...
      <q-list>
        ...
        <template v-if="isLoggedIn">
          ...
          <q-item clickable v-ripple @click="goToSwitchAccount">
            <q-item-section avatar>
              <q-icon name="swap_horiz" color="primary" />
            </q-item-section>
            <q-item-section>Switch Account</q-item-section>
          </q-item>
...
const isLoggedIn = computed(() => {
  return !!userStore.authToken || !!localStorage.getItem('auth_token');
});
