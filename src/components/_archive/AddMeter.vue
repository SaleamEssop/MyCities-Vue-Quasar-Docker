        ...
        >
          <q-date v-model="readingDate" mask="DD/MM/YYYY">
            <div class="row items-center justify-end q-gutter-sm">
              <ButtonPrimary label="Cancel" color="secondary" text-color="black" flat v-close-popup />
              <ButtonPrimary label="OK" color="primary" text-color="black" flat @click="save" v-close-popup />
            </div>
          </q-date>
        </q-popup-proxy>
        </q-btn> -->
